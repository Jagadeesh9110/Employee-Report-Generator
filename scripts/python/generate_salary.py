...
def generate_data():
    ...
    EMPLOYEE_FILE = BASE_DIR / "data" / "python" / "employees.csv"
    ATTENDANCE_FILE = BASE_DIR / "data" / "python" / "attendance.csv"
    OUTPUT_FILE = BASE_DIR / "data" / "python" / "salary.csv"
